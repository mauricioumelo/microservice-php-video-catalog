...
class DomainValidationUnitTest extends TestCase
{
    ...
    //     $this->expectException(EntityValidationException::class);
    //     $this->expectExceptionMessage('Valor informado deve possuir no minimo 5 caracteres');

    //     DomainValidation::validate($value, 5, "Valor informado deve possuir no minimo 5 caracteres");
    // }
    ...
    //     DomainValidation::validate($value, 2, "Valor informado ultrapassou o limite de caracteres");
